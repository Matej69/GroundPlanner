...
public:
    ...
    void setupUi(QWidget *ClientWindow)
    {
        ...
        ClientWindow->setStyleSheet(QStringLiteral("background:#131313;color:white;"));
        ...
        dropBox_rooms->setStyleSheet(QStringLiteral("background:#3f3f3f; color:white;font-weight:bold;"));
